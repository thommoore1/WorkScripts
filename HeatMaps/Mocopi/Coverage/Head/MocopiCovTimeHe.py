...
fileName_coverage = "Head_time_coverage.png"
fileName_csv = "Head_time_coverage_metrics.csv"
...
plt.title('Head Mocopi Data Coverage Heatmap (5-min bin resolution, 30-min display)', fontsize=14, pad=20)
