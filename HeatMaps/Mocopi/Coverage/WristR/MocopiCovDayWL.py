...
fileName_coverage = "WristR_day_coverage.png"
fileName_csv      = "WristR_day_coverage_metrics.csv"
...
plt.title('WristR Mocopi Data Coverage Heatmap by Weekday (Class Times Only, 5-min bins)', fontsize=14, pad=20)
