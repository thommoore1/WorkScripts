...
fileName_coverage = "ankleR_time_coverage.png"
fileName_csv = "ankleR_time_coverage_metrics.csv"
...
plt.title('AnkleR Mocopi Data Coverage Heatmap (5-min bin resolution, 30-min display)', fontsize=14, pad=20)
