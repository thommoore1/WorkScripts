...
fileName_coverage = "Hip_time_coverage.png"
fileName_csv = "Hip_time_coverage_metrics.csv"
...
plt.title('Hip Mocopi Data Coverage Heatmap (5-min bin resolution, 30-min display)', fontsize=14, pad=20)
